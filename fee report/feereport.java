...
final JComboBox<String> cb1
= new JComboBox<String>(language);
...
= new JComboBox<String>(languagess);


cb2.setBounds(250, 650, 90, 20);
l8 = new JLabel(
"Cources Offered here are:");
l8.setBounds(900, 150, 250, 20);


rb1 = new JRadioButton("B-tech");
rb1.setBounds(600, 150, 100, 30);


rb2 = new JRadioButton("M-tech");
rb2.setBounds(700, 150, 100, 30);
...
= new JComboBox<String>(languages);
cb.setBounds(1060, 150, 90, 20);
...
li1.addElement("CSE(1,10,000)");
li1.addElement("ECE(1,10,000)");
li1.addElement("EEE(1,10,000)");
li1.addElement("MECH(1,10,000)");
li1.addElement("CIVIL(1,10,000)");
...
list1.setBounds(600, 300, 125, 100);
